...
export default function JourneyText() {
  return (
    <>
      <OutputText>
        My journey into tech has not been entirely straight forward - Although
        that may not be entirely uncommon, I have taken a unique path.
      </OutputText>
      <OutputText>
      ...
      <OutputText>
        ...
        Fast-forward to today, and I am still putting in the time and effort to
        upskill and ensure this dream becomes a reality - it is a lifetime
        learning journey that I am ready for. I am currently a Junior Developer,
        but with enough time and dedication, I am certain that I will be able to
        fulfil my desire of contributing to meaningful projects in the future.
      </OutputText>
      <OutputText>
